    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            O LLM analisa o conteúdo do documento e os requisitos de simulação, extrai as sementes da realidade e gera automaticamente a estrutura de ontologia adequada.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Com base na ontologia gerada, o documento é automaticamente dividido em partes e o Zep é chamado para construir o grafo de conhecimento, extraindo entidades e relações, formando memória temporal e resumos de comunidade.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Construção do grafo concluída. Prossiga para configurar o ambiente de simulação.</p>
          <button
            class="action-btn"
