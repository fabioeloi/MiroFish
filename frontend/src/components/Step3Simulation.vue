        ...
        <div class="platform-status twitter" :class="{ active: runStatus.twitter_running, completed: runStatus.twitter_completed }">
          ...
          <div class="actions-tooltip">
            ...
            <div class="tooltip-actions">
              ...
              <span class="tooltip-action">REPOSTAR</span>
        ...
        <div class="platform-status reddit" :class="{ active: runStatus.reddit_running, completed: runStatus.reddit_completed }">
          ...
          <div class="actions-tooltip">
            ...
            <div class="tooltip-actions">
              ...
              <span class="tooltip-action">CURTIR</span>
              <span class="tooltip-action">NÃO CURTIR</span>
              ...
              <div class="card-body">
                ...
                <template v-if="action.action_type === 'LIKE_POST'">
                  <div class="like-info">
                    ...
                    <span class="like-label">Curtiu a publicação de @{{ action.action_args?.post_author_name || 'User' }}</span>
                  </div>
                ...
                <template v-if="action.action_type === 'UPVOTE_POST' || action.action_type === 'DOWNVOTE_POST'">
                  <div class="vote-info">
                    ...
                    <span class="vote-label">{{ action.action_type === 'UPVOTE_POST' ? 'Votou positivamente na' : 'Votou negativamente na' }} publicação</span>
                  </div>
...
const doStartSimulation = async () => {
  ...
  // Resetar todos os estados antes de iniciar, para não ser afetado pela simulação anterior
  resetAllState()
  ...
  try {
    ...
    if (props.maxRounds) {
      ...
      addLog(`Definindo número máximo de rodadas: ${props.maxRounds}`)
    }

    addLog('Modo de atualização dinâmica de grafo ativado')
    ...
    if (res.success && res.data) {
      ...
      if (isCompleted || platformsCompleted) {
        if (platformsCompleted && !isCompleted) {
          addLog('✓ Detectado que todas as plataformas finalizaram a simulação')
        }
...
const handleNextStep = async () => {
  ...
  try {
    ...
    addLog(`✗ Exceção ao iniciar geração do relatório: ${err.message}`)
    isGeneratingReport.value = false
  }
}
...
onMounted(() => {
  addLog('Inicialização da execução da simulação - Etapa 3')
  if (props.simulationId) {
    doStartSimulation()
  }
})
